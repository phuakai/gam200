...
// --- here we're trying to emulate GL's functions for clearing colorbuffer ---
  ...
  struct Model {
      ...
      std::vector<float> signedarea;
  };

  static std::vector<std::pair<std::string, Model>> modelstorage;

  static void viewport_transformation(Model& mdltransform);
  ...
  static void render_wireframe(glm::vec3 p0, glm::vec3 p1, glm::vec3 p2, Color clr);
...
// the function returns true.
  static bool render_triangle(glm::vec3 const& p0, glm::vec3 const& p1,
      glm::vec3 const& p2, Color clr);

  static glm::vec4 EdgeEquationTopLeft(glm::vec3 const& p0, glm::vec3 const& p1);

  static bool PointInEdgeTopLeftOptimized(glm::vec4& E, glm::vec3 P);
